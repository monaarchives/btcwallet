...
[![GoDoc](https://godoc.org/github.com/monaarchives/btcwallet/walletdb?status.png)]
(http://godoc.org/github.com/monaarchives/btcwallet/walletdb)
...
http://localhost:6060/pkg/github.com/monaarchives/btcwallet/walletdb

## Installation

```bash
$ go get github.com/monaarchives/btcwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/monaarchives/btcwallet/walletdb#example-package--BasicUsage)  
